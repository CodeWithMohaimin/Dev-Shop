          ...
          <section className="max-w-5xl bg-gray-900 w-full mx-auto px-5 pb-10">
            ...
            <div>
              <p className="text-gray-300 text-xs sm:text-lg">
                ...
                স্টোর করা হয়। জাভাস্ক্রিপ্টে দুই ধরনের ভেরিয়েবল আছে। 1. local
                variable 2.Global variable এই দুই ধরনের ভেরিয়েবলের পরিচিতি পরে
                জানলেও হবে। তার আগে জেনে নিই ভেরিয়েবল কিভাবে লিখতে হয় বা
                ডিক্লেয়ার করতে হয়। ভেরিয়েবল ডিক্লেয়ার করা বা লেখার কয়েকটা
                নিয়ম আছে যেমন,, ‌1. variable ডিক্লেয়ার করার জন্য var / let /
                const এই তিনটা যেকোনো একটা ব্যবহার করা। ‌var / let / const
                কিওয়ার্ড এর পাশে ভেরিয়েবলের একটি নাম সেট করা ‌ভেরিয়েবল এর নাম
                সই শুরু হতে হবে ইংলিশ লেটার দিয়ে সংখ্যা দিয়ে বা কোন আইকন
                ব্যবহার করা যাবে না। কিন্তু নামের শেষে বা মাঝে সংখ্যা ব্যবহার
                করা যাবে। এবং ছোট হাতের অক্ষর দিয়ে শুরু করতে হবে। ‌ভেরিয়েবল এর
                নাম যদি দুইটা word হয় তাহলে ক্যামেল কেস বা এভাবে লিখতে হবে।
                ‌ভেরিয়েবল নাম লেখার পরে = সাইন দিয়ে তার পাশে ভেরিয়েবলের
                ভ্যালু দিতে হবে। ‌স্ট্রিং বা অথবা একটি সেন্টেন্স হলে ডবল কোটেশন
                বা সিঙ্গেল কোটেশন ব্যবহার করতে হব। সংখ্যা হলে কোটেশন ব্যবহার করা
                লাগবে না ‌ভেরিয়েবল এর ভ্যালুর শেষে সেমিকোলন ব্যবহার করা ভালো
                এভাবেই আমরা মূলত ভেরিয়েবল ডিক্লেয়ার করতে পারি। local variable
                and global variable সম্পর্কে জানতে learn more এ click করুন
              </p>
            </div>
          </section>
        </section>
